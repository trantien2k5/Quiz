...
function startPractice(setOrId) {
  ...
  _quiz.activeDisplayInterval = setInterval(() => {
    ...
    // Bản song song trong .practice-hint-placeholder (layout xoay ngang) — element này bị
    // innerHTML ghi đè mỗi lần đổi câu nên phải re-query mỗi tick, không cache node
    const sideEl = document.getElementById('practice-hud-timer-side');
