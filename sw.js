...
const STATIC = [
  ...
  './js/core/app.js?v=68',
  './js/home/home.js?v=68',
  './js/editor/editor.js?v=68',
  './js/quiz/quiz.js?v=68',
  './js/results/results.js?v=68',
  './js/library/library.js?v=68',
  './js/history/history.js?v=68',
  './js/ai/ai.js?v=68',
  './manifest.json',
  './assets/icon-192.svg',
  './assets/icon-512.svg'
